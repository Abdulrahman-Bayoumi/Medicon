...
if(isset($_POST['submit'])){
	...
	$update_site = "UPDATE site_info SET site_name = '$name' ,dateils = '$dateils', address = '$address' , phone = '$phone' , facebook = '$facebook',twitter = '$twitter' , instgram = '$instgram'";
